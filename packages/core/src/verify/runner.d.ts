...
import { VerificationReport, VerificationProfile, VerificationMode, VerificationScope } from './types';
...
export declare class VerificationRunner {
    ...
    private repoRoot;
    private runner;
    constructor(memory: ProceduralMemory, toolPolicy: ToolPolicy, ui: UserInterface, eventBus: EventBus, repoRoot: string);
    run(profile: VerificationProfile, mode: VerificationMode, scope: VerificationScope, ctx: RunnerContext): Promise<VerificationReport>;
