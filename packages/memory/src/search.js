...
class MemorySearchService {
    ...
    async vectorSearch(request) {
        ...
        const vectorHits = await vectorBackend.query({}, repoId, new Float32Array(queryVector), topKVector);
    ...
    async hybridSearch(request) {
        const { query, topKLexical = 10, topKVector = 10, fallbackToLexicalOnVectorError, topKFinal, } = request;
